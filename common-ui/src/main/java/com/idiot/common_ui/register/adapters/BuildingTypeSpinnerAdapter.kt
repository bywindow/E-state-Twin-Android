...
import com.idiot.common_ui.databinding.ListItemBuildingTypeSpinnerBinding
...
class BuildingTypeSpinnerAdapter(
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        try {
            binding.type = model
            binding.buildingTypeItem.setTextColor(ContextCompat.getColor(context,R.color.register_info_edit_text_hint))
        } catch (e: Exception) {
            e.printStackTrace()
        }
        return binding.root
